...
public class Network2Input1Hidden {
    ...
    private ActivationFunctionInterface outputActivationFunction;
    private MultiLayerActivationFunctionInterface hiddenLayerActivFunction;
    private int outThresh;
    private int hiddenThresh;
    ...
    public Network2Input1Hidden(MultiLayerActivationFunctionInterface hiddenLayerActivFunction,
        ...
        this.hiddenLayerActivFunction = hiddenLayerActivFunction;
        this.hiddenThresh = hiddenThresh;
        this.outThresh = outThresh;
    }
    ...
    public void train(ArrayList<Double[]> dataSet, double learningRate) {
        ...
        while (true) {
            ...
            while (this.noOfEpochsInLastTrain < 1000) {
                double SSE = 0;
                ...
                for (int i = 0; i < dataSet.size(); i++) {
                    ...
                    if (error != 0) {
                        ...
                        for (int j = 0; j < 2; j++) {
                            hidden[j].updateValues(threshModifications[j], nodeModifications[j]);
                        }
